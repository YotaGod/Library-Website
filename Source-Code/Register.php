...
if (isset($_REQUEST['Username'])) {
    ...
    // If no error occurs, insert values into the database.
    $Query = "INSERT INTO UsersTable (Username, Password, FirstName, Surname, AddressLine1, AddressLine2, City, Telephone, Mobile)
              VALUES ('$Username', '".md5($Password)."', '$FirstName', '$Surname', '$AddressLine1', '$AddressLine2', '$City', '$Telephone', '$Mobile')";
    ...
    if (mysqli_query($Connection, $Query)) {
        ...
        echo "<div class='Form'><h3>Error: " . mysqli_error($Connection) . "</h3><br/></div>";
    }
}
